        ...
        return when (
            val response =
                service.subscriptions(
                    ...
                    notInLearningPackage = notInLearningPackage
                )
        ) {
            is Either.Right -> {
                Either.Right(mapper.listSubscriptionsToDomain(response.b))
